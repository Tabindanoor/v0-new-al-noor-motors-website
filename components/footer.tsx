    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <Link href="#home" className="flex flex-col mb-6">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Your premier destination for new and used cars in Faisalabad. 
              Experience excellence in automotive services.
            </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-muted-foreground">
                  Shop No. B-7, Ground Floor, 9 Madina Colony, Main Sargodha Road, Faisalabad
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0 mt-1" />
                <div className="text-muted-foreground">
                  <a href="tel:03009665022" className="hover:text-primary transition-colors block">
                    0300-9665022
                  </a>
                  <a href="tel:03369665022" className="hover:text-primary transition-colors block">
                    0336-9665022
                  </a>
                </div>
              </li>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground text-center md:text-left">
              © {new Date().getFullYear()} New Al-Noor Motors. All rights reserved.
            </p>
            <p className="text-sm text-muted-foreground">
              Trusted Name in New & Used Cars
            </p>
          </div>
        </div>
      </div>
